...
![宝塔面板开心版11.0.0 更新：修复与优化并行，体验再升级](/uploads/2026/08/fd770f7b-e844-46d3-ae2c-904329e2d909-1da4a2a7.jpg)
...
![宝塔面板开心版11.0.0 更新：修复与优化并行，体验再升级](/uploads/2026/08/QQ20260805-231218-190efef1.png)
...
![宝塔面板开心版11.0.0 更新：修复与优化并行，体验再升级](/uploads/2026/08/QQ20260805-231255-606d6d3f.png)
...
```bash
curl -fL https://io.bt.sy/install/update_panel.sh -o update_panel.sh
```
...
1. 系统用户和 SSH 公钥是否出现异常；
2. root 用户的登录记录；
3. `/etc/cron*` 与面板计划任务；
4. 正在监听的端口；
5. 异常进程和外部网络连接；
6. Nginx、PHP、数据库和面板配置；
7. 面板目录中近期修改的文件；
8. 云平台 API 密钥和网站后台密码。
...
1. 导出可信的网站文件和数据库；
2. 创建一台全新的服务器；
3. 使用宝塔官方程序或其他可信方案重新部署；
4. 更换 SSH、数据库、面板和网站密码；
5. 重新签发或检查相关密钥；
6. 验证业务正常后再下线旧服务器。
